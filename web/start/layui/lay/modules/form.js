...
/**
 ...
 @License：MIT
 @detail: 源码改动
 1、暴露submit函数在form.prototype.submit
...
layui.define('layer', function(exports){
  ...
  var submit = function(){
    var button = $(this), verify = form.config.verify, stop = null
      ...
      // 获取提交表单dom
      ,elem = button.parents(ELEM).length=== 0?button.parents(".layui-layer").find('form'):button.parents(ELEM)
    ...
    layui.each(fieldElem, function(_, item){
      ...
      if(!item.name) return;
      //过滤隐藏项
      // if(layui.$(item).parent().is(":hidden")) return;
