layui.define(['table', 'form', 'laydate'], function (exports) {
  ...
  var initArray = [{
    formNameConf: "announce_login-announce_form",
    tableId: "table_login-announce",
    formClass: ".form_login-announce",
    type: "login"
  },
    {
      formNameConf: "announce_game-announce_form",
      tableId: "table_game-announce",
      formClass: ".form_game-announce",
      type: "game"
    }];
