layui.define( ['table', 'admin', 'form', 'view', 'laydate', 'element', 'common'], function(exports){
    ...
    var initArray = new Array(
        {formNameConf:"form_player-chat-auto-timing", tableId:"table_auto-timing", formClass:".form_player-chat-auto-timing", type:"auto-timing"}
    );
    ...
    $.each(initArray, function(i, obj){
        admin.initForms(obj.formNameConf, '#'+obj.formNameConf).then(function () {
            ...
            $("#Time").parent().css('width', '500px');
            admin.getCols('form_auto-timing').then(function (data) {
        ...
        if(obj.id > 0){
            layui.admin.popup({
                ...
                ,success: function(layero, index){
                    layui.view(this.id).render('ban/auto_timing',{id:obj.id,reason: 'BannedChatReason',type:'chat_ban'});
                }
            })
        }else {
    ...
    function auto_timing() {
        layui.admin.popup({
            ...
            ,id: 'auto_timing'
            ,success: function(layero, index){
                layui.view(this.id).render('ban/auto_timing', {reason: 'BannedChatReason',type:'chat_ban'});
            }
        })
    }
