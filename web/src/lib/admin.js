...
layui.define('view', function(exports){
  ...
  ,admin = {
    v: 'beta.v.1.0'
    , d : '2020-05-20'
    , desc : '1. 该版本满足一期重要的运营需求 <br/> 3. 支持基于游戏树形组织结构的权限管理<br/> 3. 支持游戏平台的切换操作'
    ...
    // 设置baseUrl(项目目录)
    ,getUrl: function (url, selfUrl = '') {
      return selfUrl == '' ? setter.baseUrl + url : selfUrl + url;
    }
    ...
    ,theme: function(options){
      ...
      ,styleText = laytpl([
        ...
        ,'.layui-nav-tree span.layui-nav-bar,'
    ...
    //事件栈
    ,_stack: function(param){
      if (!layui.cache.hasOwnProperty("stack")){
        layui.cache.stack={};
      }
      const stack = layui.cache.stack;
      const href = layui.router().href;
      if (!stack.hasOwnProperty(href)){
        stack[href] = []
      }
      stack[href].push(param)
    }
